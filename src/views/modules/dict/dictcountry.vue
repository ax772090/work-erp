<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList"  v-loading="dataListLoading" stripe>
      <el-table-column prop="nameEn" header-align="center" align="center" label="英文名称"></el-table-column>
      <el-table-column prop="nameCn" header-align="center" align="center" label="中文名称"></el-table-column>
    </el-table>
    <el-row>
      <pagination-all v-model="paginationData" @paginationChangeHandle="getDataList"></pagination-all>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    getDataList (val) {
      ...
      this.$http({
        url: this.$http.adornUrl('dict/dictcountry/list'),
        method: 'get',
        params:
