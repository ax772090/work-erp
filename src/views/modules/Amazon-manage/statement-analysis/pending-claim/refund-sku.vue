  ...
  <div>
    <el-table stripe
      ...
      <el-table-column prop="refundDate"
                       label="退款日期"></el-table-column>
      <el-table-column prop="payAmout"
                       label="付款金额"></el-table-column>
      <el-table-column prop="refundAmout"
                       label="退款金额"></el-table-column>
      <el-table-column prop="claimAmout"
                       label="待索赔金额"></el-table-column>
      <el-table-column prop="diffDate"
                       label="距今未退货时长(天)"></el-table-column>
          ...
          <el-dropdown :show-timeout="20">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="ignoreHandle"
                                @click.native="ignoreHandle(scope.row.amazonOrderId)"
              ...
              <el-dropdown-item command="selfShipmentHandle"
                                ...
                                :disabled="!(scope.row.orderStatus === 'Pending')">发起索赔申请</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
