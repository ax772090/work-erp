  ...
  <div>
    ...
    <el-table stripe
      ...
      <el-table-column prop="amount"
                       label="总金额"
                       v-if="feeType !=='vat'"></el-table-column>
      <el-table-column prop="taxPoint"
                       label="税点"></el-table-column>
...
import AddOrUpdate from './outside-vat-add'
// 导入
    ...
    excelImport () {
      this.$nextTick(() => {
        this.$refs.xlsImport.init({
          templateUrl: 'basicData/exportModel?fileName=platformVatFee.xlsx',
