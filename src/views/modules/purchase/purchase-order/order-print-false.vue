<template>
  <el-dialog title="打印采购合同(不含税)"
    ...
    <div ref="prints"
         class="bg">
      <div class="box"><img src="../../../../../static/img/bg.png"
             alt=";ihof;hhf;oiho;fhoa;wigh;oawi"></div>
      ...
      <table border="1"
        ...
        <tr>
          <td style="text-align:left">合同总金额{{printData.currency?`(${printData.currency})`:''}}</td>
          <td>大写:</td>
        ...
        <tr>
          <td colspan='8'
              style="text-align:left">备注:&nbsp;{{ printData.remark }}</td>
        </tr>
      </table>
      <div class="appoint">
        <div class="appoint-content">
          <!-- <p>二、付款方式：<span class="spanchp">&nbsp;&nbsp;{{printData.payMode}}&nbsp;&nbsp;</span> -->
          ...
          <p>付款方式：
            ...
            <!-- <p><span class="spanchp">&nbsp;&nbsp;{{printData.supplierName}}&nbsp;&nbsp;</span>
          </p> -->
            ...
            <p style="margin-top:20px;text-align: justify;">四、检验方法：乙方在交付前应对所交付的产品进行检验，同时提供生产厂商的检验报告；乙方交货时，甲方对产品按照AQL0.65标准进行随机抽查与核对数量，若发现产品质不符合约定标准或交付数量与订单不符，甲方有权拒绝收货，由此给甲方带来的损失由乙方承担。如甲方为异地交货，则甲方应在收到货物后七个工作日内提出异议，拒收不合格品并要求及时更换合格品交货。</p>
        ...
        <div class="signature">
          <div class="width50">
            ...
            <div class="height50"
                 style="margin-top:5px">法定法人或代表：</div>
          </div>
          <div class="width50">
