...
<template>
  <div>
    ...
    <el-table stripe
      ...
      <el-table-column prop="freightPrice"
                       label="运费单价"></el-table-column>
...
import AddOrUpdate from './head-price-add'
// 导入
    ...
    excelImport () {
      this.$nextTick(() => {
        this.$refs.xlsImport.init({
          templateUrl: 'basicData/exportModel?fileName=platformHeadFreightFee.xlsx',
